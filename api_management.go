...
*/
func (r apiCopyCampaignToApplicationsRequest) Execute() (InlineResponse2004, *_nethttp.Response, error) {
	var (
...
type apiCreateCustomEffectRequest struct {
	ctx        _context.Context
	apiService *ManagementApiService
	body       *NewCustomEffect
}

func (r apiCreateCustomEffectRequest) Body(body NewCustomEffect) apiCreateCustomEffectRequest {
	r.body = &body
	return r
}
...
Create a _custom effect_ in this account.

  - @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return apiCreateCustomEffectRequest
*/
func (a *ManagementApiService) CreateCustomEffect(ctx _context.Context) apiCreateCustomEffectRequest {
	return apiCreateCustomEffectRequest{
		apiService: a,
		ctx:        ctx,
	}
...
Execute executes the request
	...
	@return CustomEffect
*/
func (r apiCreateCustomEffectRequest) Execute() (CustomEffect, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ManagementApiService.CreateCustomEffect")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
- You can review the payload you will receive in the [specs](https://docs.talon.one/outbound-notifications#/paths/campaign_created/post).
...
type apiCreatePicklistRequest struct {
	ctx        _context.Context
	apiService *ManagementApiService
	body       *NewPicklist
}

func (r apiCreatePicklistRequest) Body(body NewPicklist) apiCreatePicklistRequest {
	r.body = &body
	return r
}

/*
CreatePicklist Create picklist
Create a _picklist_ in this account.

  - @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return apiCreatePicklistRequest
*/
func (a *ManagementApiService) CreatePicklist(ctx _context.Context) apiCreatePicklistRequest {
	return apiCreatePicklistRequest{
		apiService: a,
		ctx:        ctx,
	}
...
Execute executes the request
	...
	@return Picklist
*/
func (r apiCreatePicklistRequest) Execute() (Picklist, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  Picklist
	)

	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ManagementApiService.CreatePicklist")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/picklist"
...
*/
func (a *ManagementApiService) DeleteAttribute(ctx _context.Context, attributeId int32) apiDeleteAttributeRequest {
	return apiDeleteAttributeRequest{
		apiService:  a,
		ctx:         ctx,
...
type apiDeleteCustomEffectRequest struct {
	ctx            _context.Context
	apiService     *ManagementApiService
...
@return apiDeleteCustomEffectRequest
*/
func (a *ManagementApiService) DeleteCustomEffect(ctx _context.Context, customEffectId int32) apiDeleteCustomEffectRequest {
	return apiDeleteCustomEffectRequest{
		apiService:     a,
		ctx:            ctx,
...
Execute executes the request
*/
func (r apiDeleteCustomEffectRequest) Execute() (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
...
type apiDeletePicklistRequest struct {
	ctx        _context.Context
	apiService *ManagementApiService
	picklistId int32
}
...
Delete an existing picklist.
  - @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param picklistId The ID of the picklist.

@return apiDeletePicklistRequest
*/
func (a *ManagementApiService) DeletePicklist(ctx _context.Context, picklistId int32) apiDeletePicklistRequest {
	return apiDeletePicklistRequest{
		apiService: a,
		ctx:        ctx,
...
Execute executes the request
*/
func (r apiDeletePicklistRequest) Execute() (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ManagementApiService.DeletePicklist")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/picklist/{picklistId}"
	localVarPath = strings.Replace(localVarPath, "{"+"picklistId"+"}", _neturl.QueryEscape(parameterToString(r.picklistId, "")), -1)
...
The CSV file contains the following columns:
  ...
  - `recipientintegrationid`: The integration ID of the customer considered as recipient of the coupon.
...
- `state`: The [state](https://docs.talon.one/docs/dev/concepts/entities#customer-session-states) of the session.
...
- `event_type`: The name of the event. See the [docs](https://docs.talon.one/docs/dev/concepts/events).
...
*/
func (r apiGetAccessLogsWithoutTotalCountRequest) Execute() (InlineResponse20018, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (r apiGetAllRolesRequest) Execute() (InlineResponse20040, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (r apiGetApplicationCustomerFriendsRequest) Execute() (InlineResponse20030, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
See also: [Track an event](https://docs.talon.one/integration-api#operation/trackEvent)
...
*/
func (r apiGetApplicationsRequest) Execute() (InlineResponse2003, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (r apiGetAttributesRequest) Execute() (InlineResponse20031, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
Execute executes the request
	...
	@return InlineResponse2004
*/
func (r apiGetCampaignByAttributesRequest) Execute() (InlineResponse2004, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (r apiGetCampaignTemplatesRequest) Execute() (InlineResponse20010, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
Execute executes the request
	...
	@return InlineResponse2004
*/
func (r apiGetCampaignsRequest) Execute() (InlineResponse2004, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (r apiGetCollectionItemsRequest) Execute() (InlineResponse20016, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (r apiGetCouponsWithoutTotalCountRequest) Execute() (InlineResponse2008, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
GetCustomEffect Get custom effect
...
Execute executes the request
	...
	@return CustomEffect
*/
func (r apiGetCustomEffectRequest) Execute() (CustomEffect, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ManagementApiService.GetCustomEffect")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (r apiGetEventTypesRequest) Execute() (InlineResponse20036, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
Retrieve the transaction logs for the given [loyalty card](https://docs.talon.one/docs/product/loyalty-programs/loyalty-cards/loyalty-card-overview)
...
*/
func (r apiGetLoyaltyCardTransactionLogsRequest) Execute() (InlineResponse20014, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
Retrieve all loyalty program transaction logs in a given loyalty program with filtering options applied. Manual and imported transactions are also included.
...
*/
func (r apiGetNotificationWebhooksRequest) Execute() (InlineResponse2005, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
type apiGetPicklistRequest struct {
	ctx        _context.Context
	apiService *ManagementApiService
	picklistId int32
}
...
/*
GetPicklist Get picklist
Retrieve the specified picklist.

  - @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param picklistId The ID of the picklist.

@return apiGetPicklistRequest
*/
func (a *ManagementApiService) GetPicklist(ctx _context.Context, picklistId int32) apiGetPicklistRequest {
	return apiGetPicklistRequest{
		apiService: a,
		ctx:        ctx,
		picklistId: picklistId,
...
Execute executes the request
	...
	@return Picklist
*/
func (r apiGetPicklistRequest) Execute() (Picklist, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ManagementApiService.GetPicklist")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (r apiGetReferralsWithoutTotalCountRequest) Execute() (InlineResponse2009, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (r apiGetRulesetsRequest) Execute() (InlineResponse2006, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (r apiGetWebhookActivationLogsRequest) Execute() (InlineResponse20034, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (r apiGetWebhookLogsRequest) Execute() (InlineResponse20035, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (r apiGetWebhooksRequest) Execute() (InlineResponse20033, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
Depending on the loyalty program type, you can import the points into a given customer profile or into a given _active_ loyalty card.
...
- `startdate`: The earliest date when the points can be redeemed. On this date and until the expiration date, the points are `active`.
...
*/
func (r apiListAccountCollectionsRequest) Execute() (InlineResponse20015, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
For more information, see [Managing notifications](https://docs.talon.one/docs/product/loyalty-programs/managing-notifications).
...
Execute executes the request
	...
	@return InlineResponse2008
*/
func (r apiSearchCouponsAdvancedApplicationWideWithoutTotalCountRequest) Execute() (InlineResponse2008, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
Execute executes the request
	...
	@return InlineResponse2008
*/
func (r apiSearchCouponsAdvancedWithoutTotalCountRequest) Execute() (InlineResponse2008, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
type apiUpdateCustomEffectRequest struct {
	ctx            _context.Context
	apiService     *ManagementApiService
	customEffectId int32
	body           *NewCustomEffect
...
func (r apiUpdateCustomEffectRequest) Body(body NewCustomEffect) apiUpdateCustomEffectRequest {
	r.body = &body
	return r
}

/*
UpdateCustomEffect Update custom effect
Update an existing custom effect.

  - @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param customEffectId The ID of the custom effect. You can find the ID in the Campaign Manager's URL when you display the details of an custom effect in **Account** > **Tools** > **Custom Effects**.

@return apiUpdateCustomEffectRequest
*/
func (a *ManagementApiService) UpdateCustomEffect(ctx _context.Context, customEffectId int32) apiUpdateCustomEffectRequest {
	return apiUpdateCustomEffectRequest{
		apiService:     a,
		ctx:            ctx,
		customEffectId: customEffectId,
...
Execute executes the request
	...
	@return CustomEffect
*/
func (r apiUpdateCustomEffectRequest) Execute() (CustomEffect, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ManagementApiService.UpdateCustomEffect")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
**Tip:** You can review the payload you will receive in the [specs](https://docs.talon.one/outbound-notifications#/paths/campaign_edited/post).
...
type apiUpdatePicklistRequest struct {
	ctx        _context.Context
	apiService *ManagementApiService
	picklistId int32
	body       *NewPicklist
...
func (r apiUpdatePicklistRequest) Body(body NewPicklist) apiUpdatePicklistRequest {
	r.body = &body
	return r
}

/*
UpdatePicklist Update picklist
Update an existing picklist

  - @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param picklistId The ID of the picklist.

@return apiUpdatePicklistRequest
*/
func (a *ManagementApiService) UpdatePicklist(ctx _context.Context, picklistId int32) apiUpdatePicklistRequest {
	return apiUpdatePicklistRequest{
		apiService: a,
		ctx:        ctx,
		picklistId: picklistId,
...
Execute executes the request
	...
	@return Picklist
*/
func (r apiUpdatePicklistRequest) Execute() (Picklist, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ManagementApiService.UpdatePicklist")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
